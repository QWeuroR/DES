...
\FEIauthor{titul. Meno Priezvisko, titul}

% Evidence number
\FEIregNr{FEI-xxxx-xxxx}

% Title
\FEItitle{Šablóna dokumentácie v \LaTeX}
...
\FEIcourseTag{I-KÓDpredmetu}         % Course code
\FEIcourse{Názov predmetu}       % Course name in Slovak
