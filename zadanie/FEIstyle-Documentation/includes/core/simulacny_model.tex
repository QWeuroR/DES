...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim=1.5cm 3.2cm 2.2cm 3.5cm, clip]{img/Response_best4_Pe_no_PSS.pdf} % zmeňte na img/vas_obrazok_bez_pss.png
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim=1.5cm 3.2cm 2.2cm 3.5cm, clip]{img/Response_best4_Pe.pdf} % zmeňte na img/vas_obrazok_s_pss.png
